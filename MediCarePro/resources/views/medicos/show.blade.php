    ...
    <div class="container">
        ...
        <div>
            <div class="d-flex flex-row justify-content-between">
                ...
                <div>
                    {{-- Novo Atendimento --}}
                    <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#atendimentosCreateModal"> <i
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        @forelse ($atendimentos as $atendimento)
                            <tr>
                                <td class="{{ $atendimento->data_atendimento >= date('Y-m-d') ? 'text-danger' : '' }}">
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('atendimentos.destroy', $atendimento->id) }}" method="post"
                                        ...
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="text-white btn btn-danger"> <i
